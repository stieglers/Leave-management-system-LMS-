    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner container" style="background-color:teal;">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color:white; font-size:20px;">Panel For Pending Leave History</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title" style="color:black;">Pending Leave History</span>
