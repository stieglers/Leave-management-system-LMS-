...
<html lang="en">
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner container" style="background-color:teal; font-size:20px;">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="align:center; color:white;">Panel For Changing Password</div>
                    </div>
