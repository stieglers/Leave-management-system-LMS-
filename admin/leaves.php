    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner container" style="background-color:teal;">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color:white; align:center; font-size:20px">Panel For Viewing Leave History</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title" style="font-size:20px; color:black; align:center;"> Leave History</span>
