...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">OLMS</span>
                        </div>
            ...
            <main class="mn-inner" style="background-color:teal; background-image:url(assets/images/cyp.jpg)">
            
                <div class="row">
                    <div class="col8">
                        <div class="page-title" align="center"><h4 style="color:white;">Welcome to Employee Leave Management System</h4></div>

                          <div class="col s8 m10 l6 offset-l2 offset-m2">
                              <div class="card white darken-1">

                                  <div class="card-content">
                                      <span class="card-title" style="font-size:20px;"><center>Employee Login</center></span>
