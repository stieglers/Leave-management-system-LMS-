    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner" style="background-color:teal;">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="font-size:18px; color:white;">Panel For Leave History</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title" style="font-size:18px; color:black;">Leave History</span>
